...
window.getWorkInfo = function(workId, cb) {
  $.ajax({
    url: window.apiServer+'/api/teaching/teachingWork/studentWorkInfo',
    data: { workId: workId },
...
window.getScratchAssets = function(assetType, cb){
  let data;
  $.ajax({
    url: window.apiServer+'/api/teaching/teachingScratchAssets/getScratchAssets?assetType='+assetType,
...
window.getQiniuToken = function() {
  var qn_token;
  $.ajax({
    url: window.apiServer+'/api/common/qiniu/getToken',
    beforeSend: function(request) {
      request.setRequestHeader('X-Access-Token', getUserToken())
    },
    async: false,
  ...
  function uploadFile(fileName, fileTag, filePath, fileLocation) {
    var id = null;
    $.ajax({
      url: window.apiServer+'/api/system/sysFile/add',
      type: 'POST',
      dataType: 'json',
  ...
  function getUnitInfo(unitId, cb){
    $.ajax({
      url: window.apiServer+'/api/teaching/teachingCourseUnit/getUnitWorkInfo',
      data: {
        unitId: unitId
      },
      beforeSend: function(request) {
