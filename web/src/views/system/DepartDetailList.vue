    ...
    <a-col :md="8" :sm="24">
      <a-card :bordered="false">
        <div style="background: #fff;padding-left:16px;height: 100%; margin-top: 5px">
          ...
          <div style="margin-top: 24px;" v-else><h3>学生用户无此权限</h3></div>
        </div>
      </a-card>
    </a-col>
    <a-col :md="16" :sm="24">
      <a-card :bordered="false">
        <a-tabs defaultActiveKey="2" @change="callback">
          ...
          <a-tab-pane tab="课程信息" key="4" forceRender>
  ...
  export default {
    ...
    methods: {
      ...
      clearSelectedDepartKeys() {
        ...
        this.$refs.DeptCourseInfo.currentDeptId='';
      },
      loadTree() {
        var that = this
        that.treeData = []
      ...
      onSelect(selectedKeys, e) {
        ...
        this.$refs.DeptRoleInfo.open(record);
        this.$refs.DeptCourseInfo.onClearSelected();
        this.$refs.DeptCourseInfo.open(record);
      },
    },
    created() {
