...
export default function Page() {
  ...
  return <CrudList
    ...
    title="公告管理"
    columns={[{title:'标题',dataIndex:'title'},{title:'类型',dataIndex:'msgCategory_dictText'},{title:'优先级',dataIndex:'priority_dictText'},{title:'状态',dataIndex:'sendStatus_dictText'},{title:'发布时间',dataIndex:'sendTime'}]}
