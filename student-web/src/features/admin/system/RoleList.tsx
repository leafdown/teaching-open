...
import { Modal, Tree, message, Spin, Tooltip } from 'antd'
...
export default function Page() {
  ...
  return <>
    <CrudList
      ...
      extraActions={(record:any)=> <Tooltip title="授权"><a onClick={()=>openAuth(record)}><i className="fas fa-shield-alt" /></a></Tooltip>}
    />
